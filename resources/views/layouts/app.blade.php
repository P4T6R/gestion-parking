            ...
            <div class="page-wrap">
                ...
                <footer class="footer">
                    <div class="w-100 clearfix">
                        <span class="text-center text-sm-left d-md-inline-block">Copyright © 2024 Système de Gestion de Parking. Tout les droits sont reservés.</span>
                        <span class="float-none float-sm-right mt-1 mt-sm-0 text-center">Fait Par Cephas CONGO</span>
                    </div>
                </footer>
